...
########################### INTRO FUNCTIONS ####################################
    ...
    def start_draw(self):
        ...
        self.draw_text('PREMI "SPAZIO"', self.screen, [
                       WIDTH//2, HEIGHT//2-50], START_TEXT_SIZE, (170, 132, 58), START_FONT, centered=True)
        self.draw_text('1 GIOCATORE', self.screen, [
...
########################### PLAYING FUNCTIONS ##################################
    ...
    def playing_draw(self):
        ...
        self.draw_coins()
        # self.draw_grid()
        self.draw_text('PUNTEGGIO: {}'.format(self.player.current_score),
                       self.screen, [60, 0], 18, WHITE, START_FONT)
        self.draw_text('MIGLIORE: 0', self.screen, [WIDTH//2+60, 0], 18, WHITE, START_FONT)
        self.player.draw()
        for enemy in self.enemies:
            enemy.draw()
        pygame.display.update()
...
########################### GAME OVER FUNCTIONS ################################
    ...
    def game_over_draw(self):
        self.screen.fill(BLACK)
        quit_text = '"ESC" per USCIRE'
        again_text = '"SPAZIO" per GIOCARE DI NUOVO'
